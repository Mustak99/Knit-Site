                            ...
                            <div class="row">
                                ...
                                <div class="offset-xl-1 col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 p-3">
                                    ...
                                    <div class="text-muted mb-0 mt-3 legend-item"> <span
                                            ...
                                            class="legend-text">Previous Week</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <ul class="list-group">
                                ...
                                <?php foreach ($labels as $index => $label): ?>
                                    <li class="list-group-item" style=" <?php echo $colors[$index % count($colors)]; ?>;">
                                        <?php echo '<span class="fa-xs text-brand mr-1 legend-title"><i class="fa fa-fw fa-square-full"></i></span> <span class="legend-text"></span>'; echo $label; ?>: <?php echo $values[$index]; ?>
                                    </li>
                                <?php endforeach; ?>
                            </ul>
                        </div>
