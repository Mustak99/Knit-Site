...
<i class="fa fa-dashboard"> </i> Dashboard / Edit Delivery Boy Salary
...
<i class="fa fa-money fa-fw"> </i> Edit Delivery Boy Salary
...
echo "<script>alert('One Delivery Boy Salary Has Been Updated')</script>";
