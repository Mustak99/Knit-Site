...
<i class="fa fa-dashboard"></i> Dashboard / View Delivery Boy Salary
...
<i class="fa fa-money fa-fw"></i> View Delivery Boy Salary
...
<a href="index.php?delete_deliveryboysalary<?php echo $coupon_id; ?>">
...
<a href="index.php?edit_deliveryboysalary=<?php echo $coupon_id; ?>">
