...
<i class="fa fa-dashboard"> </i> Dashboard / Insert Delivery Boy Salary
...
<i class="fa fa-money fa-fw"> </i> Insert Delivery Boy Salary
...
<label class="col-md-3 control-label"> Delivery Boy Name </label>
...
<label class="col-md-3 control-label"> Delivery Boy Email </label>
...
<div class="form-group" ><!-- form-group Starts -->
<label class="col-md-3 control-label"> Delivery Boy Salary </label>
...
<input type="submit" name="submit" class=" btn btn-primary form-control" value=" Insert Salary">
...
echo "<script>alert('New Delivery Boy Salary Has Been Inserted')</script>";

echo "<script>window.open('index.php?view_deliveryboysalary','_self')</script>";
