...
$query = "SELECT o.order_id, o.order_date, o.status, oi.product_id, p.name AS product_name, p.image_path, oi.quantity, oi.total_price
          FROM orders o
...
if ($result) {
    while ($row = $result->fetch_assoc()) {
        ...
        <div class="card-footer p-4" style="background-color:#D19C97;border-radius:0px 0px 10px 10px;">
