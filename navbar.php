 ...
 <!-- Navbar Start -->
  <div class="container-fluid mb-5">
        <div class="row border-top px-xl-5">
            ...
            <div class="col-lg-9">
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    <a href="" class="text-decoration-none d-block d-lg-none">
                        <h1 class="m-0 display-5 font-weight-semi-bold"><span class="text-primary font-weight-bold border px-3 mr-1"></span>Knite Site</h1>
                    </a>
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            <a href="<?php if($order) {echo "../HomePage.php";} else{echo "HomePage.php";} ?>" class="nav-item nav-link active">Home</a>
                            <a  href="<?php if($order) {echo "../cart/cart.php";} else{echo "cart/cart.php";} ?>"class="nav-item nav-link" style="display: <?php if (isset($_SESSION["CustomerUserID"])||isset($_SESSION["SellerUserID"])) { echo "block";} else { echo "none";}?>">Cart</a>
                ...
                <div id="header-carousel" class="carousel slide" data-ride="carousel" style="display: <?php if (isset($_SESSION["search"])) { echo "none";}elseif($order){echo "none";} else { echo "block";}?>">
            ...
            <?php if(isset($order)){}else{echo "</div></div>";} ?>
