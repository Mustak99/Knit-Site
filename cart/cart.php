...
<body>
  ...
  <div class="container-fluid pt-5">
    ...
    JOIN products p ON c.product_id = p.id WHERE c.user_id = $customer_id";
        ...
        $shippingCost = 10; // You already have this defined
        $totalAmount += $shippingCost;
        ?>
        <!-- Cart Summary HTML -->
        <div class="card border-secondary mb-5">
          <div class="card-header bg-seconda  ry border-0">
          ...
          <div class="card-footer border-secondary bg-transparent">
            <div class="d-flex justify-content-between mt-2">
              ...
              <h5 class="font-weight-bold" id="total" name="total"><?php echo number_format($totalAmount, 2); ?></h5>
            </div>
...
<script>
  var options = {
    ...
    "handler": function(response) {
      window.location.href = "OrderPlaced.jsp";
    },
    "modal": {
      "ondismiss": function() {
  ...
  document.getElementById('rzp-button1').onclick = function(e) {
    ...
    var tm = parseInt(element.textContent); // Get the amount from the "total" element
    options.amount = tm;
    rzp1.open();
    e.preventDefault();
  }
